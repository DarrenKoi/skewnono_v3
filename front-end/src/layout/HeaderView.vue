<template>
  <header
    ...
    <router-link to="/" class="flex items-center gap-4 py-2 no-underline">
      <!-- <img src="@/assets/skewnono_logo_sm2.png" alt="Logo" class="w-8 h-8" /> -->
      <span
        class="text-xl font-medium text-surface-900 dark:text-surface-0 hover:text-primary transition-colors duration-150">SKEWNONO
        v3</span>
    </router-link>
