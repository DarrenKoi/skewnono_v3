  ...
  <div class="weekly-trend bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 xl:px-20">
    <div class="flex flex-col items-start gap-4 mb-8">
      ...
      <div class="flex flex-col gap-2">
        <div class="text-surface-900 dark:text-surface-0 font-semibold text-3xl">Weekly Trend</div>
        <div class="text-surface-500 dark:text-surface-300 text-lg">
          Analyze weekly data trends for facility {{ facId }}
        </div>
      </div>
    </div>
    ...
    <div v-if="!selectedCategory && !loading && weeklyData && Object.keys(weeklyData).length > 0"
      ...
      <div class="text-center py-12">
        ...
        <p class="text-surface-600 dark:text-surface-300 text-lg">Select a category above to view weekly trends</p>
      </div>
    </div>
